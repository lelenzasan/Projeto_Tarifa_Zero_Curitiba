...
- [Principais Descobertas e Conclusões](#-principais-descobertas-e-conclusões)
...
*   **Dados de Usuários Diários**: [URBS - Rede Integrada de Transporte](https://www.urbs.curitiba.pr.gov.br/transporte/rede-integrada-de-transporte/51)
...
1.  **Configuração e Importação**: Setup do ambiente com as bibliotecas necessárias e montagem do Google Drive para acesso a arquivos.
2.  **Teste de Hipóteses**: Análise do impacto da meia tarifa aos domingos e feriados no fluxo de passageiros pagantes, utilizando teste t de Student.
3.  **Análise da Pandemia**: Quantificação do impacto da pandemia (2020-2021) na demanda de passageiros, com visualizações de série temporal e médias móveis.
4.  **Cálculo de KPIs da Meia Tarifa**: Estimativa da perda de receita, aumento de custo operacional e impacto líquido (subsídio) da política de meia tarifa, considerando tarifas públicas e técnicas variáveis por ano.
...
*   **Impacto Financeiro Líquido**: O investimento diário total (subsídio) para a meia tarifa foi de **R$ 591.343,48**, composto por R$ 181.937,21 de perda de receita e R$ 409.406,28 de aumento de custo operacional.
...
*   **Custo Anual Estimado**: O custo total anual estimado para o passe livre aos domingos e feriados é de aproximadamente **R$ 31.090.264,78**, o que equivale a um investimento médio mensal de **R$ 2.590.855,40**.
...
1.  **Clonar o Repositório**: Faça um clone deste repositório para sua máquina local ou ambiente de desenvolvimento.
    ```bash
